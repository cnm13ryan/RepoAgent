...
class BaseChatEngine:
    """Shared chat engine logic for different LLM backends."""

    def __init__(self, llm_cls: Type[LLM], project_manager):
    ...
    def build_prompt(self, doc_item: DocItem):
        """Build the prompt messages used for the LLM call."""
    ...
    def generate_doc(self, doc_item: DocItem):
        """Generate documentation for the provided DocItem."""
